...
{
    public class CargaHomologacionCCFF
    {
        ...
        {
            Logger.Info("Se inició la carga del archivo Homologacion CCFF");
            Console.WriteLine("Se inició la carga del archivo Homologacion CCFF");

            string tipoArchivo = TipoArchivo.HomologacionCCFF.GetStringValue();
            var cargaBase = new CargaBase(tipoArchivo, "HomologacionCCFF");
            ...
            try
            {
                ...
                foreach (var fileName in filesNames)
                {
                    ...
                    cargaBase.RegistrarCarga(dt, "HomologacionCCFF");
                }
            }
            catch (Exception ex)
            {
            ...
            Logger.Info("Se terminó la carga del archivo Homologacion CCFF");
            Console.WriteLine("Se terminó la carga del archivo Homologacion CCFF");
        }
