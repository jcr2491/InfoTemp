...
{
    public class CargaHomologacionEmpleado
    {
        ...
        {
            Logger.Info("Se inició la carga del archivo Homologacion Empleado");
            Console.WriteLine("Se inició la carga del archivo Homologacion Empleado");

            string tipoArchivo = TipoArchivo.HomologacionEmpleado.GetStringValue();
            var cargaBase = new CargaBase(tipoArchivo, "HomologacionEmpleado");
            ...
            Logger.Info("Se terminó la carga del archivo Homologacion Empleado");
            Console.WriteLine("Se terminó la carga del archivo Homologacion Empleado");
        }
