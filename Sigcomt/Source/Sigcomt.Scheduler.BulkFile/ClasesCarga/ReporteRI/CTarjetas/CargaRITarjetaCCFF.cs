...
{
     public class CargaRITarjetaCCFF
    {
        ...
        {
            Logger.Info("Se inició la carga del archivo Tarjeta CCFF");
            Console.WriteLine("Se inició la carga del archivo Tarjeta CCFF");
            ...
            Logger.Info("Se terminó la carga del archivo Tarjeta CCFF");
            Console.WriteLine("Se terminó la carga del archivo Tarjeta CCFF");
        }
