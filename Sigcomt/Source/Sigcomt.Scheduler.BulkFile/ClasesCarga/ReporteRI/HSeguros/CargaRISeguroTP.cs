...
namespace Sigcomt.Scheduler.BulkFile.ClasesCarga.ReporteRI.HSeguros
{
    public class CargaRISeguroTP
    {
        ...
        {
            Logger.Info("Se inició la carga del archivo Seguro Falabella");
            Console.WriteLine("Se inició la carga del archivo Seguro Falabella");
            var cargaBase = new CargaBase<RISeguroTP>();
            string tipoArchivo = TipoArchivo.RISeguroTP.GetStringValue();
            int cabeceraId = 0;
            int cont = 0;
            bool fileError = true;
            ...
            try
            {
                cargaBase = new CargaBase<RISeguroTP>(tipoArchivo);
                ...
                foreach (var fileName in filesNames)
                {
                    ...
                    DataTable dt = Utils.CrearCabeceraDataTable<RISeguroTP>();
                    ...
                    fileError = false;
                    CargaArchivoBL.GetInstance().Add(dt, "RISeguroTP");
            ...
            Logger.Info("Se terminó la carga del archivo Seguro Falabella");
            Console.WriteLine("Se terminó la carga del archivo Seguro Falabella");
        }
