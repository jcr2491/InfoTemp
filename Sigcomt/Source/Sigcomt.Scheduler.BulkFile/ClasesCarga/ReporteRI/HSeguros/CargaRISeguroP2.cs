...
namespace Sigcomt.Scheduler.BulkFile.ClasesCarga.ReporteRI.HSeguros
{
    public class CargaRISeguroP2
    {
        ...
        {
            Logger.Info("Se inició la carga del archivo Seguro - Producto 2");
            Console.WriteLine("Se inició la carga del archivo Seguro - Producto 2");
            ...
            try
            {
                ...
                foreach (var fileName in filesNames)
                {
                    ...
                    fileError = false;
                    CargaArchivoBL.GetInstance().Add(dt, "RISeguroP2");
            ...
            Logger.Info("Se terminó la carga del archivo Seguro - Producto 2");
            Console.WriteLine("Se terminó la carga del archivo Seguro - Producto 2");
        }
