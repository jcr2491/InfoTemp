   ...
   public class CargaRISeguroP1
    {
        ...
        {
            Logger.Info("Se inició la carga del archivo Seguro - Producto 1");
            Console.WriteLine("Se inició la carga del archivo Seguro - Producto 1");
            var cargaBase = new CargaBase<RISeguroP1>();
            ...
            try
            {
                cargaBase = new CargaBase<RISeguroP1>(tipoArchivo);
                ...
                foreach (var fileName in filesNames)
                {
                    ...
                    DataTable dt = Utils.CrearCabeceraDataTable<RISeguroP1>();
                    ...
                    fileError = false;
                    CargaArchivoBL.GetInstance().Add(dt, "RISeguroP1");
            ...
            Logger.Info("Se terminó la carga del archivo Seguro - Producto 1");
            Console.WriteLine("Se terminó la carga del archivo Seguro - Producto 1");
        }
