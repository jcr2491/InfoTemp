...
namespace Sigcomt.Scheduler.BulkFile.ClasesCarga.ReporteRI.BParticipación
{
    public class CargaRIParticipacionSodimac
    {
        ...
        {
            Logger.Info("Se inició la carga del archivo RIParticipacionSodimac");
            Console.WriteLine("Se inició la carga del archivo RIParticipacionSodimac");
            var cargaBase = new CargaBase<RIParticipacionSodimac>();
            string tipoArchivo = TipoArchivo.RIParticipacionSodimac.GetStringValue();
            int cabeceraId = 0;
            int cont = 0;
            bool fileError = true;
            ...
            try
            {
                 cargaBase = new CargaBase<RIParticipacionSodimac>(tipoArchivo);
                ...
                foreach (var fileName in filesNames)
                {
                    ...
                    DataTable dt = Utils.CrearCabeceraDataTable<RIParticipacionSodimac>();
                    ...
                    while (row != null)
                    {
                        ...
                        if (Tienda.StartsWith("Esquema", StringComparison.InvariantCultureIgnoreCase)) break;
            ...
            Logger.Info("Se terminó la carga del archivo RIParticipacionSodimac");
            Console.WriteLine("Se terminó la carga del archivo RIParticipacionSodimac");
        }
