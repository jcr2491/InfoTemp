...
{
    public class CargaRIDerivacionHeavyPlataforma
    {
        ...
        public static void CargarArchivo()
        {
            ...
            try
            {
                cargaBase = new CargaBase<RIDerivacionHeavyPlataforma>(tipoArchivo);
                ...
                foreach (var fileName in filesNames)
                {
                    ...
                    DataTable dt = Utils.CrearCabeceraDataTable<RIDerivacionHeavyPlataforma>();
            ...
            Logger.Info("Se terminó la carga del archivo Derivacion Heavy Plataforma");
            Console.WriteLine("Se terminó la carga del archivo Derivacion Heavy Plataforma");
        }
