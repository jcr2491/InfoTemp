...
namespace Sigcomt.Scheduler.BulkFile.ClasesCarga.ReporteRI.DTiemposdeEspera
{
    public class CargaRITEPlataforma
    {
        ...
        {
            Logger.Info("Se inició la carga del archivo Tiempo de Espera - Plataforma");
            Console.WriteLine("Se inició la carga del archivo Tiempo de Espera - Plataforma");
            var cargaBase = new CargaBase<RITEPlataforma>();
            ...
            try
            {
                 cargaBase = new CargaBase<RITEPlataforma>(tipoArchivo);
                ...
                foreach (var fileName in filesNames)
                {
                    ...
                    DataTable dt = Utils.CrearCabeceraDataTable<RITEPlataforma>();
            ...
            Logger.Info("Se terminó la carga del archivo Tiempo de Espera - Plataforma");
            Console.WriteLine("Se terminó la carga del archivo Tiempo de Espera - Plataforma");
        }
