...
{
    public class CargaEscalaFormatoCCFF
    {
        ...
        {
            Logger.Info("Se inició la carga del archivo Escala formato CCFF");
            Console.WriteLine("Se inició la carga del archivo Escala formato CCFF");

            string tipoArchivo = TipoArchivo.EscalaFormatoCCFF.GetStringValue();
            var cargaBase = new CargaBase(tipoArchivo, "EscalaFormatoCCFF");
            ...
            try
            {
                ...
                foreach (var fileName in filesNames)
                {
                    ...
                    cargaBase.RegistrarCarga(dt, "EscalaFormatoCCFF");
                }
            }
            catch (Exception ex)
            {
            ...
            Logger.Info("Se terminó la carga del archivo Escala formato CCFF");
            Console.WriteLine("Se terminó la carga del archivo Escala formato CCFF");
        }
