...
namespace Sigcomt.Scheduler.BulkFile.ClasesCarga.MatenimientoIndicador
{
    public class CargaPesoKPI
    {
        ...
        {
            Logger.Info("Se inició la carga del archivo Peso KPI");
            Console.WriteLine("Se inició la carga del archivo Peso KPI");
            ...
            Logger.Info("Se terminó la carga del archivo Peso KPI");
            Console.WriteLine("Se terminó la carga del archivo Peso KPI");
        }
