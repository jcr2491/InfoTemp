...
namespace Sigcomt.Scheduler.BulkFile.ClasesCarga.MatenimientoIndicador
{
    public class CargaTarifarioIndicador
    {
        ...
        {
            Logger.Info("Se inició la carga del archivo Tarifario Indicador");
            Console.WriteLine("Se inició la carga del archivo Tarifario Indicador");
            ...
            Logger.Info("Se terminó la carga del archivo Tarifario Indicador");
            Console.WriteLine("Se terminó la carga del archivo Tarifario Indicador");
        }
