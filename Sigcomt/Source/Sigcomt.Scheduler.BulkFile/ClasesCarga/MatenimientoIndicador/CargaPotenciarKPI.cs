...
{
    public class CargaPotenciarKPI
    {
        ...
        {
            Logger.Info("Se inició la carga del archivo Potencia de kPI");
            Console.WriteLine("Se inició la carga del archivo Potencia de kPI");

            string tipoArchivo = TipoArchivo.PotenciarKPI.GetStringValue();
            var cargaBase = new CargaBase(tipoArchivo, "PotenciarKPI");
            ...
            try
            {
                ...
                foreach (var fileName in filesNames)
                {
                    ...
                    cargaBase.RegistrarCarga(dt, "PotenciarKPI");
                }
            }
            catch (Exception ex)
            {
            ...
            Logger.Info("Se terminó la carga del archivo Potencia de kPI");
            Console.WriteLine("Se terminó la carga del archivo Potencia de kPI");
        }
