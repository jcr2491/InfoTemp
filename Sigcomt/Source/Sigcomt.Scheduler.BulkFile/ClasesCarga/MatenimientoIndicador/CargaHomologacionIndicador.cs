...
{
    public class CargaHomologacionIndicador
    {
        ...
        {
            Logger.Info("Se inició la carga del archivo Homologacion Indicadores");
            Console.WriteLine("Se inició la carga del archivo Homologacion Indicadores");

            string tipoArchivo = TipoArchivo.HomologacionIndicador.GetStringValue();
            var cargaBase = new CargaBase(tipoArchivo, "HomologacionIndicador");
            ...
            try
            {
                ...
                foreach (var fileName in filesNames)
                {
                    ...
                    cargaBase.RegistrarCarga(dt, "HomologacionIndicador");
                }
            }
            catch (Exception ex)
            {
            ...
            Logger.Info("Se terminó la carga del archivo Homologacion Indicadores");
            Console.WriteLine("Se terminó la carga del archivo Homologacion Indicadores");
        }
