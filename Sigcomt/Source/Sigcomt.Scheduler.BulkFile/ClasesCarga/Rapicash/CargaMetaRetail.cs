...
namespace Sigcomt.Scheduler.BulkFile.ClasesCarga.Rapicash
{
    public class CargaMetaRetail
    {
        ...
        {
            Logger.Info("Se inició la carga del archivo MetaTottusRapicash");
            Console.WriteLine("Se inició la carga del archivo MetaTottusRapicash");
            ...
            Logger.Info("Se terminó la carga del archivo MetaTottusRapicash");
            Console.WriteLine("Se terminó la carga del archivo MetaTottusRapicash");
        }
        ...
        private static DataRow GetDataRow(DataTable dt, GenericExcel excel, IRow row)
        {
            ...
            dr["TiendaId"] = TiendaRetail.Tottus.GetStringValue();
