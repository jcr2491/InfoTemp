...
{
    public class CargaMetaSodimacRapicash
    {
        ...
        {
            Logger.Info("Se inició la carga del archivo MetaSodimacRapicash");
            Console.WriteLine("Se inició la carga del archivo MetaSodimacRapicash");
            var cargaBase = new CargaBase<MetaTiendaRetail>();
            string tipoArchivo = TipoArchivo.MetaSodimacRapicash.GetStringValue();
            int cabeceraId = 0;
            int cont = 0;
            bool fileError = true;
            ...
            Logger.Info("Se terminó la carga del archivo MetaSodimacRapicash");
            Console.WriteLine("Se terminó la carga del archivo MetaSodimacRapicash");
        }
        ...
        private static DataRow GetDataRow(DataTable dt, GenericExcel excel, IRow row)
        {
            ...
            dr["TiendaId"] = TiendaRetail.Sodimac.GetStringValue();
