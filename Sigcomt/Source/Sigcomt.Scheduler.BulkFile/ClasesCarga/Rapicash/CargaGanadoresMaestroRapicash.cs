...
{
    public class CargaGanadoresMaestroRapicash
    {
        ...
        public static void CargarArchivo()
        {
            ...
            string tipoArchivo = TipoArchivo.GanadoresMaestroRapicash.GetStringValue();
            ...
            Logger.Info("Se terminó la carga del archivo GanadoresMaestroRapicash");
            Console.WriteLine("Se terminó la carga del archivo GanadoresMaestroRapicash");
        }
