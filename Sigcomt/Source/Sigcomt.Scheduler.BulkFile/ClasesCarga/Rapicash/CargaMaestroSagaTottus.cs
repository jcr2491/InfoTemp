...
{
    public class CargaMaestroSagaTottus
    {
        ...
        {
            Logger.Info("Se inició la carga del archivo Maestro Rapicash Saga y Tottus");
            Console.WriteLine("Se inició la carga del archivo Maestro Rapicash Saga y Tottus");

            string tipoArchivo = TipoArchivo.MaestroSagaTottus.GetStringValue();
            var cargaBase = new CargaBase(tipoArchivo, "MantenimientoSagaTottus");
            ...
            try
            {
                ...
                foreach (var fileName in filesNames)
                {
                    ...
                    while (row != null)
                    {
                        ...
                        string tipoComisionId = Utils.GetValueColumn(
                    ...
                    cargaBase.RegistrarCarga(dt, "MantenimientoSagaTottus");
                }
            }
            catch (Exception ex)
            {
            ...
            Logger.Info("Se terminó la carga del archivo Maestro Rapicash Saga y Tottus");
            Console.WriteLine("Se terminó la carga del archivo Maestro Rapicash Saga y Tottus");
        }
