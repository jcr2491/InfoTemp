...
{
    public class CargaMaestroSodimacMaestro
    {
        ...
        {
            Logger.Info("Se inició la carga del archivo Maestro Rapicash Sodimac y Maestro");
            Console.WriteLine("Se inició la carga del archivo Maestro Rapicash Sodimac y Maestro");

            string tipoArchivo = TipoArchivo.MaestroSodimacMaestro.GetStringValue();
            var cargaBase = new CargaBase(tipoArchivo, "MantenimientoSodimacMaestro");
            ...
            try
            {
                ...
                foreach (var fileName in filesNames)
                {
                    ...
                    cargaBase.RegistrarCarga(dt, "MantenimientoSodimacMaestro");
                }
            }
            catch (Exception ex)
            {
            ...
            Logger.Info("Se terminó la carga del archivo Maestro Rapicash Sodimac y Maestro");
            Console.WriteLine("Se terminó la carga del archivo Maestro Rapicash Sodimac y Maestro");
        }
