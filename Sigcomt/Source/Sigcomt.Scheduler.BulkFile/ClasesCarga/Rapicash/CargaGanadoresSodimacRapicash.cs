...
{
    public class CargaGanadoresSodimacRapicash
    {
        ...
        public static void CargarArchivo()
        {
            ...
            string tipoArchivo = TipoArchivo.GanadoresSodimacRapicash.GetStringValue();
            var cargaBase = new CargaBase(tipoArchivo, "GanadoresRetailRapicash");
                ...
                foreach (var fileName in filesNames)
                {
                    ...
                    while (row != null)
                    {
                        ...
                        if (!string.IsNullOrWhiteSpace(empleado))
                        {
                            ...
                            dr["Secuencia"] = cont;
                                dr["TiendaId"] = TiendaRetail.Sodimac.GetNumberValue();
                    ...
                    cargaBase.RegistrarCarga(dt, "GanadoresRetailRapicash");
                }
            }
            catch (Exception ex)
            {
