...
namespace Sigcomt.WinForms.BulkCopy.ClasesCarga.ReporteRI.FActivos
{
    public class CargaRIActivosRapicashCCFF
    {
        ...
        public static void CargarArchivo()
        {
            ...
            var cargaBase = new CargaBase(tipoArchivo, "RIActivosRapicashCCFF");
                ...
                foreach (var fileName in filesNames)
                {
                    ...
                    while (!cargaBase.EsFilaVacia(excel, row))
                    {
                        ...
                        if (!isValid)
                        {
                         ...
                         var ccffId = Utils.GetValueColumn(excel.GetCellToString(row,
