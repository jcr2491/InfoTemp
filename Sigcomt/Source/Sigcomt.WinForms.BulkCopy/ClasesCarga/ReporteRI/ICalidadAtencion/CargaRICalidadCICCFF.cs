...
namespace Sigcomt.WinForms.BulkCopy.ClasesCarga.ReporteRI.ICalidadAtencion
{
    public class CargaRICalidadCICCFF
    {
        ...
        public static void CargarArchivo()
        {
            ...
            var cargaBase = new CargaBase(tipoArchivo, "RICalidadAtencionCI");
            ...
            try
            {
                ...
                foreach (var fileName in filesNames)
                {
                    ...
                    cargaBase.RegistrarCarga(dt, "RICalidadAtencionCI");
                }
            }
            catch (Exception ex)
            {
