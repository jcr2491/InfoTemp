...
{
    public class CargaMetaEmpleadoCCFFAutomotriz
    {
        ...
        public static bool CargarArchivo()
        {
            ...
            string tipoArchivo = TipoArchivo.MetaEmpleadoCCFFAutomotriz.GetStringValue();
            if (!UtilsLocal.PermitirCargaArchivo(tipoArchivo)) return false;
           
            UtilsLocal.AsignarEstadoInicioCarga(tipoArchivo);
            var cargaBase = new CargaBase(tipoArchivo, "EmpleadoCCFFAutomotriz");
            ...
            try
            {
                ...
                foreach (var fileName in filesNames)
                {
                    ...
                    cargaBase.RegistrarCarga(dt, "EmpleadoCCFFAutomotriz");
