...
{
    public class CargaMantenimientoAutomotriz
    {
        ...
        public static bool CargarArchivo()
        {
            ...
            string tipoArchivo = TipoArchivo.MantenimientoAutomotriz.GetStringValue();
            if (!UtilsLocal.PermitirCargaArchivo(tipoArchivo)) return false;
           
            UtilsLocal.AsignarEstadoInicioCarga(tipoArchivo);
            var cargaBase = new CargaBase(tipoArchivo, "MantenimientoAutomotriz");
            ...
            try
            {
                ...
                foreach (var fileName in filesNames)
                {
                    ...
                    cargaBase.RegistrarCarga(dt, "MantenimientoAutomotriz");
