...
{
    public class CargaGestionIndivudalKPIUAC
    {
        ...
        public static bool CargarArchivo()
        {
            ...
            string tipoArchivo = TipoArchivo.GestionIndividualKPIUAC.GetStringValue();
            if (!UtilsLocal.PermitirCargaArchivo(tipoArchivo)) return false;

            UtilsLocal.AsignarEstadoInicioCarga(tipoArchivo);
            var cargaBase = new CargaBase(tipoArchivo, "KpiUAC");
            ...
            try
            {
                ...
                foreach (var fileName in filesNames)
                {
                    ...
                    cargaBase.RegistrarCarga(dt, "KpiUAC");
