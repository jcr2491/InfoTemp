...
namespace Falabella.CrossCutting
{
    public class ExcelXls
    {
        ...
        public HSSFWorkbook WorkBook => _workBook;

        public ExcelXls(Stream s, string nombreHoja)
        {
            _workBook = new HSSFWorkbook(s);
            _sheet = _workBook.GetSheet(nombreHoja);
        }

        public ExcelXls(Stream s, int indexHoja)
        {
            _workBook = new HSSFWorkbook(s);
            _sheet = _workBook.GetSheetAt(indexHoja);
        }

        public ExcelXls(string nombreHoja)
        {
