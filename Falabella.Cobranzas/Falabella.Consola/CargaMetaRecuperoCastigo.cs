...
namespace Falabella.Consola
{
    public class CargaMetaRecuperoCastigo
    {
        ...
        {
            Logger.Info("Se inició la carga del archivo MetaRecuperoCastigo");
            Console.WriteLine("Se inició la carga del archivo MetaRecuperoCastigo");
            ...
            Logger.Info("Se terminó la carga del archivo MetaRecuperoCastigo");
            Console.WriteLine("Se terminó la carga del archivo MetaRecuperoCastigo");
        }
