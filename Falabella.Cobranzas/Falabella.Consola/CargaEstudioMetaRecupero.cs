...
namespace Falabella.Consola
{
    public class CargaEstudioMetaRecupero
    {
        ...
        {
            Logger.Info("Se inició la carga del archivo EstudioMetaRecupero");
            Console.WriteLine("Se inició la carga del archivo EstudioMetaRecupero");
            ...
            Logger.Info("Se terminó la carga del archivo EstudioMetaRecupero");
            Console.WriteLine("Se terminó la carga del archivo EstudioMetaRecupero");
        }
